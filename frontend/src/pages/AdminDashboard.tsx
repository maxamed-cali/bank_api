...
import { adminDashboardService, AdminDashboardData, ChartData, Transaction } from '../services/dashboardServices';
...
const AdminDashboard = () => {
    ...
    const fetchAccounts = async () => {
        try {
            const data = await accountService.getAllByAdmin();
            setAccounts(data);
        } catch (error: any) {
    ...
    useEffect(() => {
        async function fetchChartData() {
            try {
                const data = await adminDashboardService.getMonthlyUserGrowth();
                setChartData(data);
            } catch (err) {
    ...
    useEffect(() => {
        async function fetchTransactions() {
            try {
                ...
                const data = await adminDashboardService.getSystemTransactions();
        ...
        <div className="flex flex-col gap-y-4">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                <div className={`card ${selectedAccount ? 'cursor-pointer' : ''}`} >
                    <div className="card-header">
                        ...
                        <div>
                            <p className="card-title">System Balance</p>
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-7">
                <div className="card col-span-1 md:col-span-2 lg:col-span-4">
                    <div className="card-header">
                        <p className="card-title">Monthly User Growth</p>
                    </div>
